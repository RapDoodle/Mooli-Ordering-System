...
assert c.update_user_info(10001, 'Ryan', 'Wong', 'F', '911') == {'message': 'You account info has been updated successfully.'}
assert c.change_password('10001', 'Testpassword12345', 'Testpassword123', 'Testpassword123') == {'message': 'You password has been updated successfully.'}
